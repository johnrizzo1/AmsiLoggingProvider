...
Demonstrates how to use the Antimalware Provider Interface to register as a provider and log an incoming stream.
...
* Query Logging Providers: logman providers
